...
cd /home/ajs1/camcasp-5.7/examples/properties/Formamide/HCONH2

# SAPT.bash -j HCONH2 --files "A" -scratch /scratch/fastscratch/ajs1 -scfcode dalton2013 #    -w HCONH2 -M 2500

execute.py HCONH2 --parts A --scfcode dalton2013 --scratch /scratch/fastscratch/ajs1     --work HCONH2 -M 2500 
