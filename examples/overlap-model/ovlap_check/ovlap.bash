...
# SAPT.bash -j ovlap --files "A B" -scratch /scratch/fastscratch/ajs1 -scfcode dalton2013 #    -w ovlap -M 2500

execute.py ovlap --parts A B --scfcode dalton2013 --scratch /scratch/fastscratch/ajs1     --work ovlap -M 2500 
