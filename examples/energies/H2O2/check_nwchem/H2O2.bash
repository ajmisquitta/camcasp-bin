...
# SAPT.bash -j H2O2 --files "A B" -scratch /scratch/fastscratch/ajs1 -scfcode nwchem #    -w H2O2 -M 2500

execute.py H2O2 --parts A B --scfcode nwchem --scratch /scratch/fastscratch/ajs1     --work H2O2 -M 2500 
