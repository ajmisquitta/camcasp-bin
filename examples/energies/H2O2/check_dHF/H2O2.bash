...
# SAPT.bash -j H2O2 --files "A B AB" -scratch /scratch/fastscratch/ajs1 -scfcode dalton2013 #    -w H2O2 -M 2500

execute.py H2O2 --parts A B AB --scfcode dalton2013 --scratch /scratch/fastscratch/ajs1     --work H2O2 -M 2500 
