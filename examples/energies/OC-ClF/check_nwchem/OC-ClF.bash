...
cd /home/ajs1/camcasp-5.7/examples/energies/OC-ClF/OC-ClF

# SAPT.bash -j OC-ClF --files "A B" -scratch /scratch/fastscratch/ajs1 -scfcode nwchem #    -w OC-ClF -M 2500

execute.py OC-ClF --parts A B --scfcode nwchem --scratch /scratch/fastscratch/ajs1     --work OC-ClF -M 2500 
