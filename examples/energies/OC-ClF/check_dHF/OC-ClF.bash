...
cd /home/ajs1/camcasp-5.7/examples/energies/OC-ClF/test_dHF

# SAPT.bash -j OC-ClF --files "A B AB" -scratch /scratch/fastscratch/ajs1 -scfcode dalton2013 #    -w OC-ClF -M 2500

execute.py OC-ClF --parts A B AB --scfcode dalton2013 --scratch /scratch/fastscratch/ajs1     --work OC-ClF -M 2500 
