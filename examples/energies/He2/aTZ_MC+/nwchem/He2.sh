...
cd /home/ajs1/CamCASP/examples/energies/He2/aTZ_MC+/nwchem

execute.py He2 --parts A B --scfcode nwchem --scratch /scratch/fastscratch/ajs1     --work He2 -M 1000 --nproc 1 --cores 2 --wait 0.5      --mpstat
